...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white shadow-md fixed w-full z-50 top-0">
      ...
      {/* Mobile Menu */}
      <div className={`fixed top-16 left-0 w-full bg-white px-8 pt-6 transition-all duration-700 ease-in-out lg:hidden ${toggleMenu ? "h-full opacity-100 scale-100" : "h-0 opacity-0 scale-95 overflow-hidden"
        }`}>
