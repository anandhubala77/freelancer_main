...
const Dashboard = () => {
  ...
  return (
    <div ref={contentRef} className="ml-64 p-6 overflow-y-auto h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {metrics.map((metric, index) => (
          <div
            key={index}
            className={`p-6 rounded-lg shadow-md flex items-center ${metric.color} transition-all duration-200 hover:shadow-lg`}
          >
            <div className="mr-4">
            ...
            <div>
              ...
              <p className={`text-xs mt-1 ${metric.change.includes('+') ? 'text-green-100' : 'text-red-100'}`}>
                {metric.change}
              </p>
            </div>
          </div>
